            ...
            <div className="app__home__section5__content">
              <div className="row">
                <div className="col-12 col-lg-5">
                  <Overview
                    order={1} title="Fully responsive" subtitle="In every actual browser" src="mobile.png"
                    active={true}
                  />
                  <Overview order={2} title="Multilanguage" subtitle="also fully functional abroad" src="mobile.png" />
                  <Overview
                    order={3} title="Easy to use" subtitle="also for unexperienced patients simple & fast"
                    src="mobile.png"
                  />
                  <Overview
                    order={4} title="ISO 21007 certification"
                    subtitle="For optimal security through regular security audits" src="mobile.png"
                  />
                  <Overview
                    order={5} title="Tested by doctors & hospitals"
          ...
          <section className="app__home__section7 d-none d-lg-block">
            ...
            <div className="app__home__section7__content">
              <div className="app__home__section7__content__mobile app__home__section7__content__iphone">
                <div
                  className="app__home__section7__content__mobile__img app__home__section7__content__iphone__img mx-auto"
                >
                  <img src={require('assets/media/icons/icon_apple.png')} alt="No Asset" />
                </div>
                <p className="app__home__section7__content__mobile__title app__home__section7__content__iphone__title">on
                iPhone and iPad from iOS 9
                </p>
                <button
                  type="button"
              ...
              <div className="app__home__section7__content__mobile app__home__section7__content__android">
                <div
                  className="app__home__section7__content__mobile__img app__home__section7__content__android__img mx-auto"
                >
                  <img src={require('assets/media/icons/icon_android.png')} alt="No Asset" />
                </div>
                <p className="app__home__section7__content__mobile__title app__home__section7__content__android__title">on
                Android smartphones and tablet from
                Android 4
                </p>
                <button
                  type="button"
